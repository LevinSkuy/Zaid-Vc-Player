...
async def ubalive(_, message: Message):
  ...
  alive_pic = "https://telegra.ph/file/9fae76c03979af6f929bd.jpg"
  await message.reply_photo(alive_pic, caption=f"**☑️ Oukeen Music Userbot is Alive 🌀** \n\n**🤖 Version** \n ↳**Bot Version:** `2.5` \n ↳**Userbot Version:** `0.0` \n\n**🐬 Info**\n ↳**Music Bot:** @{BOT_USERNAME} \n ↳**Owner:** [Click Here](t.me/bukanyesus)")
