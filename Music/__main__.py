...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO OUKEEN SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of OUKEEN Music Started")
    print("[INFO]: STARTED THE ZAID BOT AND SENDING THE INFO TO OUKEEN SERVER")
